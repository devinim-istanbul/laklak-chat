extern crate laklak_command_builder;

use laklak_command_builder::*;
...
//   assert_eq!(
//     command,
//     Command::<SendMessage>::build(String::from("1234567812345678"), String::from("Hello, World!"))
//   );
// }
...
//   assert_eq!(
//     command,
//     Command::<Authenticate>::build(String::from("1234567812345678"))
//   );
// }
...
//   let message = "UElORw==";
//   let command = Decode!(message);
//   assert_eq!(command, Command::<Ping>::build());
// }
...
//   let command = Decode!(message);
//   println!("{:?}", command);
//   assert_eq!(command, Command::<Pong>::build());
// }
...
// #[test]
// fn encode_command() {
//   let send_message = Command::<SendMessage>::build(
//     String::from("1234567812345678"),
